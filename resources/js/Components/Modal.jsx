    ...
    return (
        <Transition show={show} as={Fragment} leave="duration-200">
            ...
            >
                ...
                >
                    <Dialog.Panel
                        className={`my-6 max-h-screen bg-white rounded-lg overflow-x-hidden overflow-y-auto shadow-xl transform transition-all sm:w-full sm:mx-auto ${maxWidthClass}`}
                    >
                        {children}
                    </Dialog.Panel>
                </Transition.Child>
